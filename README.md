...
Не принимая на себя никакой отвественности за последствияиспользования этого скрипта, все-таки хочу отметить, что в файлах **delstudent**, **newstudent**, **tarbkp**, **zipbkp** пароли хранятся в ***ОТКРЫТОМ ВИДЕ***. И хотя файлы может просматривать только сам пользователь, это далеко от настоящей секьюрности. И все это - риски пользователя. Если у кого-то есть решение лучше, дайте знать.
