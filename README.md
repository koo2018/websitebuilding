...
5. При установке WordPress у вас спросят имя базы данных, которой сможет воспользоваться система – это имя студента, например, grp1801st01; спросят имя пользователя базы данных – это тоже имя студента, например, grp1801st01; и спросят пароль доступа этого пользователя к БД – вы его задавали при установке системы. Имя сервера всегда – localhost. Префикс может быть любым или отсутствовать.
